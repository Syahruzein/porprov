...
{
    public function getAtletByNomor(Request $request) {
        $request->validate([
            'selectNomor'=>'required'
        ]);

        $atlet = Atlet::select('id', 'name')->where('nomor_id', $request->selectNomor)->get();
        return response()->json(['success' => 'Atlet berhasil dihapus', 'atlet'=>$atlet], 200);
    }
    /**
    ...
    public function create()
    {
        ...
        return view('admin.atlet.create', $data);
    }
